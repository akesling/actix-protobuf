...
use futures::future::{err, ok, FutureExt, LocalBoxFuture, Ready, TryFutureExt};
    ...
    fn respond_to(self, _: &HttpRequest) -> Self::Future {
        ...
        match self.0.encode(&mut buf) {
            Ok(()) => ok(HttpResponse::build(StatusCode::OK)
                ...
                .body(buf)),
            Err(e) => err(Error::from(ProtoBufPayloadError::Serialize(e))),
        }
    }
}
